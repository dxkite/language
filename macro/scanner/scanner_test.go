...
func TestScanner_Scan(t *testing.T) {
	...
	tests := []struct {
		...
		{592, token.MACRO, "#"}, {593, token.ERROR, "error"}, {598, token.TEXT, " "}, {599, token.IDENT, "b"}, {600, token.TEXT, " "}, {601, token.IDENT, "is"}, {603, token.TEXT, " \\ "}, {606, token.LF, "\n"},
		{607, token.TEXT, "\t"}, {608, token.DEFINED, "defined"}, {615, token.LF, "\n"},
		{616, token.MACRO, "#"}, {617, token.ERROR, "error"}, {622, token.TEXT, " "}, {623, token.IDENT, "b"}, {624, token.TEXT, " "}, {625, token.IDENT, "is"}, {627, token.TEXT, " \\ "}, {630, token.INT, "12"}, {632, token.TEXT, " "}, {633, token.LF, "\n"},
