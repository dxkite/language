...
func TestScanner_Scan(t *testing.T) {
	...
	tests := []struct {
		...
		{131, token.MACRO, "#"}, {132, token.INCLUDE, "include"}, {139, token.TEXT, " "}, {140, token.LSS, "<"}, {141, token.IDENT, "stdio"}, {146, token.TEXT, "."}, {147, token.IDENT, "h"}, {148, token.GTR, ">"}, {149, token.LF, "\n"},
		{150, token.MACRO, "#"}, {151, token.TEXT, " "}, {152, token.INCLUDE, "include"}, {159, token.TEXT, " "}, {160, token.STRING, "\"personal.h\""}, {172, token.LF, "\n"},
		{173, token.MACRO, "#"}, {174, token.TEXT, "  "}, {176, token.ERROR, "error"}, {181, token.TEXT, " "}, {182, token.IDENT, "something"}, {191, token.TEXT, " "}, {192, token.ERROR, "error"}, {197, token.LF, "\n"},
		...
		{391, token.MACRO, "#"}, {392, token.IFNODEF, "ifndef"}, {398, token.TEXT, " "}, {399, token.IDENT, "A"}, {400, token.LF, "\n"},
		{401, token.MACRO, "#"}, {402, token.ERROR, "error"}, {407, token.TEXT, " "}, {408, token.IDENT, "missing"}, {415, token.TEXT, " "}, {416, token.IDENT, "a"}, {417, token.TEXT, " "}, {418, token.IDENT, "config"}, {424, token.LF, "\n"},
		{425, token.MACRO, "#"}, {426, token.ENDIF, "endif"}, {431, token.LF, "\n"},
		{432, token.SHR, ">>"}, {434, token.GEQ, ">="}, {436, token.OR, "|"}, {437, token.LNOT, "!"}, {438, token.TEXT, " "}, {439, token.EQU, "="}, {440, token.TEXT, " "}, {441, token.NEQ, "!="}, {443, token.TEXT, " "}, {444, token.LEQ, "<="}, {446, token.TEXT, " "}, {447, token.SHL, "<<"}, {449, token.TEXT, " "}, {450, token.MUL, "*"}, {451, token.TEXT, " "}, {452, token.REM, "%"}, {453, token.TEXT, " "}, {454, token.LAND, "&&"}, {456, token.TEXT, " "}, {457, token.AND, "&"}, {458, token.TEXT, " "}, {459, token.LOR, "||"}, {461, token.TEXT, " "}, {462, token.OR, "|"}, {463, token.TEXT, "☺"}, {466, token.IDENT, "中文"}, {472, token.TEXT, " "}, {473, token.EQL, "=="}, {475, token.LF, "\n"},
		{476, token.MACRO, "#"}, {477, token.IF, "if"}, {479, token.TEXT, " "}, {480, token.LNOT, "!"}, {481, token.DEFINED, "defined"}, {488, token.TEXT, " "}, {489, token.IDENT, "A"}, {490, token.LF, "\n"},
		{491, token.MACRO, "#"}, {492, token.ELSEIF, "elif"}, {496, token.TEXT, " "}, {497, token.FLOAT, "1f"}, {499, token.TEXT, " "}, {500, token.ADD, "+"}, {501, token.TEXT, " "}, {502, token.IDENT, "A"}, {503, token.TEXT, "  "}, {505, token.GTR, ">"}, {506, token.TEXT, " "}, {507, token.INT, "2020uL"}, {513, token.LF, "\n"},
		{514, token.MACRO, "#"}, {515, token.IFDEF, "ifdef"}, {520, token.TEXT, " "}, {521, token.IDENT, "B"}, {522, token.LF, "\n"},
		{523, token.MACRO, "#"}, {524, token.ELSE, "else"}, {528, token.LF, "\n"},
		{529, token.MACRO, "#"}, {530, token.ELSEIF, "elif"}, {534, token.LF, "\n"},
		{535, token.MACRO, "#"}, {536, token.DEFINE, "define"}, {542, token.TEXT, " "}, {543, token.IDENT, "$A"}, {545, token.TEXT, " "}, {546, token.INT, "123"}, {549, token.LF, "\n"},
		{550, token.MACRO, "#"}, {551, token.TEXT, " "}, {552, token.IDENT, "hello"}, {557, token.TEXT, " "}, {558, token.IDENT, "world"}, {563, token.LF, "\n"},
		{564, token.MACRO, "#"}, {565, token.LINE, "line"}, {569, token.TEXT, " "}, {570, token.INT, "30"}, {572, token.TEXT, " "}, {573, token.STRING, "\"test.c\""}, {581, token.TEXT, " "}, {582, token.INT, "012345678"}, {591, token.LF, "\n"},
		{592, token.MACRO, "#"}, {593, token.ERROR, "error"}, {598, token.TEXT, " "}, {599, token.IDENT, "b"}, {600, token.TEXT, " "}, {601, token.IDENT, "is"}, {603, token.TEXT, " "}, {604, token.BACKSLASH, "\\"}, {605, token.TEXT, " "}, {606, token.LF, "\n"},
		{607, token.TEXT, "\t"}, {608, token.DEFINED, "defined"}, {615, token.LF, "\n"},
		{616, token.MACRO, "#"}, {617, token.ERROR, "error"}, {622, token.TEXT, " "}, {623, token.IDENT, "b"}, {624, token.TEXT, " "}, {625, token.IDENT, "is"}, {627, token.TEXT, " "}, {628, token.BACKSLASH, "\\"}, {629, token.TEXT, " "}, {630, token.INT, "12"}, {632, token.TEXT, " "}, {633, token.LF, "\n"},
		{634, token.TEXT, "\t"}, {635, token.DEFINED, "defined"}, {642, token.LF, "\n"},
		{643, token.MACRO, "#"}, {644, token.ENDIF, "endif"}, {649, token.LF, "\n"},
		{650, token.MACRO, "#"}, {651, token.IF, "if"}, {653, token.TEXT, " "}, {654, token.INT, "123BCDE123"}, {664, token.LF, "\n"},
		...
		{679, token.MACRO, "#"}, {680, token.ENDIF, "endif"}, {685, token.LF, "\n"},
		{686, token.MACRO, "#"}, {687, token.DEFINE, "define"}, {693, token.TEXT, " "}, {694, token.IDENT, "$A"}, {696, token.LPAREN, "("}, {697, token.IDENT, "a"}, {698, token.RPAREN, ")"}, {699, token.TEXT, " "}, {700, token.INT, "123"}, {703, token.SHARP, "#"}, {704, token.IDENT, "a"}, {705, token.LF, "\n"},
		{706, token.MACRO, "#"}, {707, token.DEFINE, "define"}, {713, token.TEXT, " "}, {714, token.IDENT, "B"}, {715, token.LPAREN, "("}, {716, token.IDENT, "v"}, {717, token.RPAREN, ")"}, {718, token.TEXT, " "}, {719, token.IDENT, "$A"}, {721, token.LPAREN, "("}, {722, token.INT, "123v"}, {726, token.TEXT, " "}, {727, token.IDENT, "awd"}, {730, token.RPAREN, ")"}, {731, token.LF, "\n"},
		{732, token.IDENT, "B"}, {733, token.LPAREN, "("}, {734, token.IDENT, "awd"}, {737, token.RPAREN, ")"}, {738, token.LF, "\n"},
		{739, token.INT, "123B"}, {743, token.LF, "\n"},
		{744, token.MACRO, "#"}, {745, token.UNDEF, "undef"}, {750, token.TEXT, " "}, {751, token.IDENT, "A"}, {752, token.EOF, ""},
	}
